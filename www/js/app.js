...
angular.module("retro").controller("SkillChangeController", ["$scope", "$ionicModal", "Player", "SkillChangeFlow", "skills", function ($scope, $ionicModal, Player, SkillChangeFlow, skills) {
    $scope.player = Player.get();
